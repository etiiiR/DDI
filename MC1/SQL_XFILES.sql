...
CREATE TABLE IF NOT EXISTS `mydb`.`Abteilungen` (
  ...
  `Wichtigkeit` VARCHAR(45) NULL,
  `Aufgabenbreich` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Spesenabrechnungen` (
  ...
  INDEX `fk_Spesen_Beamte1_idx` (`Beamte_idBeamte` ASC) VISIBLE,
  INDEX `fk_Spesenabrechnungen_Adressen1_idx` (`Adressen_idAdressen` ASC) VISIBLE,
  CONSTRAINT `fk_Spesen_Beamte1`
    FOREIGN KEY (`Beamte_idBeamte`)
    REFERENCES `mydb`.`Beamte` (`idBeamte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Beamte_has_Berechtigungen` (
  ...
  PRIMARY KEY (`Beamte_idBeamte`, `Berechtigungen_idBerechtigungen`),
  INDEX `fk_Beamte_has_Berechtigungen1_Berechtigungen1_idx` (`Berechtigungen_idBerechtigungen` ASC) VISIBLE,
  INDEX `fk_Beamte_has_Berechtigungen1_Beamte1_idx` (`Beamte_idBeamte` ASC) VISIBLE,
  CONSTRAINT `fk_Beamte_has_Berechtigungen1_Beamte1`
    FOREIGN KEY (`Beamte_idBeamte`)
    REFERENCES `mydb`.`Beamte` (`idBeamte`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Beamte_has_Berechtigungen1_Berechtigungen1`
