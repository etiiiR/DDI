...
CREATE TABLE IF NOT EXISTS `mydb`.`Beamten` (
  ...
  PRIMARY KEY (`idBeamte`, `Personen_idPersonen`, `Abteilungen_idAbteilungen`),
...
-- -----------------------------------------------------
-- Table `mydb`.`Beamten_has_Berechtigungen`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Beamten_has_Berechtigungen` (
  `Beamten_idBeamte` INT NOT NULL,
  `Beamten_Personen_idPersonen` INT NOT NULL,
  `Beamten_Abteilungen_idAbteilungen` INT NOT NULL,
  `Berechtigungen_idBerechtigungen` INT NOT NULL,
  PRIMARY KEY (`Beamten_idBeamte`, `Beamten_Personen_idPersonen`, `Beamten_Abteilungen_idAbteilungen`, `Berechtigungen_idBerechtigungen`),
  INDEX `fk_Beamten_has_Berechtigungen_Berechtigungen1_idx` (`Berechtigungen_idBerechtigungen` ASC) VISIBLE,
  INDEX `fk_Beamten_has_Berechtigungen_Beamten1_idx` (`Beamten_idBeamte` ASC, `Beamten_Personen_idPersonen` ASC, `Beamten_Abteilungen_idAbteilungen` ASC) VISIBLE,
  CONSTRAINT `fk_Beamten_has_Berechtigungen_Beamten1`
    FOREIGN KEY (`Beamten_idBeamte` , `Beamten_Personen_idPersonen` , `Beamten_Abteilungen_idAbteilungen`)
    REFERENCES `mydb`.`Beamten` (`idBeamte` , `Personen_idPersonen` , `Abteilungen_idAbteilungen`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Beamten_has_Berechtigungen_Berechtigungen1`
